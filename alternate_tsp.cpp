...
int toplevel(uint32 *ram, uint32 *message_id, uint32 *number_of_cities, uint32 *scenario_id) {
    ...
    int CostGraphMatrix[12][12] = {
        { 0,  54, 124, 217,  81, 113, 179, 233, 149,  10,  24,  54 },
        { 54,  0, 189, 210,  50, 239, 144, 114,  65, 181,  51, 196 },
        { 124, 189,  0,  66,  90,  25,  95, 201,   6, 205,  44,  71 },
        { 217, 210,  66,  0, 254,  24,  88, 154,  36, 203,  56, 242 },
        { 81,  50,  90, 254,  0,  99, 237, 181, 225,  14,  49, 201 },
        { 113, 239,  25,  24,  99,  0,  16,  58,  93,  50, 119, 108 },
        { 179, 144,  95,  88, 237,  16,  0, 137, 199, 143, 139, 139 },
        { 233, 114, 201, 154, 181,  58, 137,  0,  73,  78, 247, 121 },
        { 149,  65,   6,  36, 225,  93, 199,  73,   0,  70, 236,  60 },
        { 10, 181, 205, 203,  14,  50, 143,  78,  70,   0, 243,  31 },
        { 24,  51,  44,  56,  49, 119, 139, 247, 236, 243,   0, 190 },
        { 54, 196,  71, 242, 201, 108, 139, 121,  60,  31, 190,   0 }
    };
